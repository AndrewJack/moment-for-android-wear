...
public class FriendFinderFragment extends BaseFragment implements FriendDiscoveryAdapter.FriendAddListener {
    ...
    private void friendsFound(List<FriendResponse> response) {
        ...
        if (response != null && !response.isEmpty()) {
            ...
            mFoundFriendsRecycler.setAdapter(new FriendDiscoveryAdapter(response, this, R.color.primary_text));
        } else {
            noFriendsFound();
        }
    }
            ...
            compositeSubscription.add(addObservable.subscribe(new LoaderCheckBox.RxSubscriber(view) {
                ...
                public void onNext(Void aVoid) {
                    ...
                    Observable<Void> syncPending = rxSyncFriends.syncFriends()
                            .compose(FriendFinderFragment.this.<Void>bindToLifecycle())
                            .compose(FriendFinderFragment.this.<Void>applySchedulers());
